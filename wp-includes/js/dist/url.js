 ...
 * const authority2 = getAuthority( 'https://jesreelgoldberg.github.io/portfolio:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://jesreelgoldberg.github.io/portfolio:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://jesreelgoldberg.github.io/portfolio:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://jesreelgoldberg.github.io/portfolio:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://jesreelgoldberg.github.io/portfolio:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
 ...
 * @example
 * ```js
 * const filename1 = getFilename( 'https://jesreelgoldberg.github.io/portfolio:8080/this/is/a/test.jpg' ); // 'test.jpg'
